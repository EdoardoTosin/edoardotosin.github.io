...
description: Come configurare l'autenticazione a due fattori (2FA) su Ubuntu Server con Google Authenticator per proteggere SSH prima di installare Pi-Hole e Unbound.
...
series_order: 2
translations:
  - '[[2022-12-31-ubuntu-server-pihole-unbound-part-2]]'
