...
- Horizontal field of view (derived): $\approx 78.58\degree$
...
$$
\theta = 2 \arctan\left(\frac{D_e}{W} \cdot \tan\left(\frac{\text{FOV}}{2}\right)\right)
$$
...
$$
\tan(39.29\degree) \approx 0.8182
$$

$$
\theta = 2 \cdot \arctan(0.5201 \times 0.8182)
\approx 46.1\degree
$$

## Distance from Earth's Center

Using Earth radius $R = 6371\ \text{km}$:
...
$$
\tan(23.052\degree) \approx 0.4255
$$

$$
d \approx \frac{6371}{0.4255} \approx 14972\ \text{km}
$$

## Altitude

$$
h = d - R \approx 14972 - 6371 \approx 8601\ \text{km}
$$
