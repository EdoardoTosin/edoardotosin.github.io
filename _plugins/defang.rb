...
# defang.rb - Wraps defanged URL/IP notation (hXXp/hxxp, [.], (.), [dot], (dot)) in <span class="defanged">
...
module Defang
  ...
  DOT_RE    = /\b[\w.\-]+(?:\[\.\]|\[dot\]|\(\.\)|\(dot\))(?:[\w.\-]+|\[\.\]|\[dot\]|\(\.\)|\(dot\))*\b/i.freeze
...
Jekyll::Hooks.register :documents, :post_convert do |doc|
  ...
  next unless doc.content.match?(/h[Xx]{2}p|\[\.\]|\[dot\]|\(\.\)|\(dot\)/i)
